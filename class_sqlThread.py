...
class sqlThread(threading.Thread):
    ...
    def run(self):        
        ...
        try:
            ...
            self.cur.execute(
                '''INSERT INTO subscriptions VALUES('BitXBay marketplace','BM-2cTvV6Jm3ZYpFnaoDZ3i4n9iHdNXnTTHKa',1)''')
            self.cur.execute(
                '''INSERT INTO subscriptions VALUES('BitXBay developer messages','BM-2cTmg9VYRbec5Ggzxm2r8VxUq2K2Ek7LQs',1)''')
            self.cur.execute(
