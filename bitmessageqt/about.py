...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.label.setText(_translate("aboutDialog", "BitXBay", None))
        self.labelVersion.setText(_translate("aboutDialog", "version 0.1", None))
        self.label_2.setText(_translate("aboutDialog", "<html><head/><body><p>Copyright © 2014 The BitXBay Developers</p></body></html>", None))
